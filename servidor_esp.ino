...
const char* ssid = "TADS_Alunos_2G"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO EM QUE VAI CONECTAR
const char* password = "@lun0st@ds"; //VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO EM QUE VAI CONECTAR
...
void loop() {
  ...
  String request = client.readString(); //FAZ A LEITURA DA PRIMEIRA LINHA DA REQUISIÇÃO
  int porta = request.toInt(); //CONVERTE STRING PARA INTEIRO
